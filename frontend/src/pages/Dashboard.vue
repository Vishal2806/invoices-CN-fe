      ...
      <div class="main-content">
        ...
        <div class="content-area pa-4">
          <div class="d-flex justify-space-between mb-4">
            <v-select
              v-model="filter"
              :items="['All', 'User Generated', 'Panel Generated']"
  ...
  export default {
    data() {
      return {
        ...
        logoutDialog: false,
        invoices: [
          { id: 'INV001', initiatedOn: '2025-02-25', generatedBy: 'Panel', customerName: 'John Doe' },
          { id: 'INV002', initiatedOn: '2025-02-26', generatedBy: 'User', customerName: 'Jane Smith' },
          { id: 'INV003', initiatedOn: '2025-02-27', generatedBy: 'Panel', customerName: 'Mike Johnson' },
          { id: 'INV004', initiatedOn: '2025-02-28', generatedBy: 'User', customerName: 'Sarah Brown' }
        ]
      };
    },
    computed: {
